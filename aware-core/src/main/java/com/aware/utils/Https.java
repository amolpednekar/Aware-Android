...
//                return hv.verify("example.com", session);
        ...
        try {
            ...
            InputStream certificateInputStream = new BufferedInputStream(sContext.getAssets().open("server.crt"));
	...
	public synchronized String dataPOST(String url, Hashtable<String, String> data, boolean is_gzipped) {
		...
		try{
            ...
            path_connection.setHostnameVerifier(hostnameVerifier);
