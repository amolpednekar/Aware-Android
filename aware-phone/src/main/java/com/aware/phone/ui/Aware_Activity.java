...
import com.aware.phone.SenseDB_ActionTypeList_Activity;
...
public class Aware_Activity extends AppCompatPreferenceActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getTitle().toString().equalsIgnoreCase("SenseDBActivityList")) {
            Intent about_us = new Intent(Aware_Activity.this, SenseDB_ActionTypeList_Activity.class);
            startActivity(about_us);
        }
